...
static constexpr AgentSidebarColorPalette MakeCreamAgentSidebarColorPalette() {
    ...
    const ImVec4 board_light = to_imvec4(kCreamBoardColorPalette[0]);
    const ImVec4 board_dark  = to_imvec4(kCreamBoardColorPalette[1]);
...
static constexpr AgentSidebarColorPalette kCreamAgentSidebarColorPalette = MakeCreamAgentSidebarColorPalette();
