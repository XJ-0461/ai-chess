...
static constexpr AgentSidebarColorPalette MakeDarkAgentSidebarColorPalette() {
    ...
    const ImVec4 board_light = to_imvec4(kDarkBoardColorPalette[0]);
    const ImVec4 board_dark  = to_imvec4(kDarkBoardColorPalette[1]);

    // Steps: 
    // Step 1 (100% Light): Info, Response, Move
    // Step 2 (66% Light): Error
    // Step 3 (33% Light): Quip
    // Step 4 (100% Dark): Reasoning
...
static constexpr AgentSidebarColorPalette kDarkAgentSidebarColorPalette = MakeDarkAgentSidebarColorPalette();
