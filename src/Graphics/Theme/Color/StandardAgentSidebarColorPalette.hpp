...
static constexpr AgentSidebarColorPalette MakeStandardAgentSidebarColorPalette() {
    ...
    const ImVec4 board_light = to_imvec4(kStandardBoardColorPalette[0]);
    const ImVec4 board_dark  = to_imvec4(kStandardBoardColorPalette[1]);
...
static constexpr AgentSidebarColorPalette kStandardAgentSidebarColorPalette = MakeStandardAgentSidebarColorPalette();
