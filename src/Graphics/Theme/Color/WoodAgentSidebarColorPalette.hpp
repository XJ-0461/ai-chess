...
static constexpr AgentSidebarColorPalette MakeWoodAgentSidebarColorPalette() {
    ...
    const ImVec4 board_light = to_imvec4(kWoodBoardColorPalette[0]);
    const ImVec4 board_dark  = to_imvec4(kWoodBoardColorPalette[1]);
...
static constexpr AgentSidebarColorPalette kWoodAgentSidebarColorPalette = MakeWoodAgentSidebarColorPalette();
